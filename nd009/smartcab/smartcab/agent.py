...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.trialRank += 1
            #self.epsilon -= self.decaySpee
            self.epsilon = self.originEps * math.exp(-1 * self.trialRank * self.decaySpee)
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if random.random() < self.epsilon:
                ...
                action = random.choice([action for action in self.Q[state] if self.Q[state][action] == self.get_maxQ(state)])
